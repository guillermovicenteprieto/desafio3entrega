...
routeUser.post('/login', passport.authenticate('login',
    { failureRedirect: '/login-error' }), userController.loginPost);
routeUser.post('/registro', upload.single('image'), passport.authenticate('signup', 
    { failureRedirect: '/registro-error' }), userController.registroPost);
