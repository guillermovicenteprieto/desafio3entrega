...
class productDao {
  ...
  async getAllProducts() {
    try {
      ...
      const products = await productClass.getAllProducts();
  ...
  async getProductById(id) {
    try {
      ...
      const producto = await productClass.getProductById(id);
  ...
  async createProduct(product) {
    try {
      ...
      const productoCreado = await productClass.createProduct(product);
  ...
  async updateProduct(id, product) {
    try {
      ...
      const productoActualizado = await productClass.update(id, product);
  ...
  async deleteProduct(id) {
    try {
      ...
      const productoEliminado = await productClass.delete(id);
