...
Log4js.configure({
    appenders: {
        ...
        loggerError: { type: "logLevelFilter", appender: "dataError", level: "error" },
    },
    categories: {
        default: { appenders: ["consola"], level: "all" },
        prod: { appenders: ["loggerInfo", "loggerWarn", "loggerError"], level: "info" },
        dev: { appenders: ["loggerInfo", "loggerWarn", "loggerError"], level: "debug" },
    },
});
